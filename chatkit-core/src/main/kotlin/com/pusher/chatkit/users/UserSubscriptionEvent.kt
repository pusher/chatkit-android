...
sealed class UserSubscriptionEvent {
    ...
    internal data class LeftRoomEvent(val roomId: String, val userId: String) : UserSubscriptionEvent() // v1
    internal data class JoinedRoomEvent(val roomId: String, val userId: String) : UserSubscriptionEvent() // v1
