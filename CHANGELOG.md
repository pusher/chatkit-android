...
## [Unreleased](https://github.com/pusher/chatkit-android/compare/1.9.0...HEAD)

## [1.9.0](https://github.com/pusher/chatkit-android/compare/1.8.4...1.9.0)
...
- Updated the Pusher Platform Android dependency to 1.0.5.
